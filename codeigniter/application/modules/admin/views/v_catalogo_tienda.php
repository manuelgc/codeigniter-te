<?php echo form_open('admin/c_tienda_com_admin/filtrarTienda','id="form-filtro-tiendas"',array('reordenar' => '1'));?>
			<ul class="content-form-tienda">
				<li id="li-nombre-tienda" class="item-pedido-usuario"><label
					class="description" for="nombre_tienda">Nombre Tienda </label>
					<div>
					<input type="text" class="element text medium" maxlength="255" name="nombre_tienda" />
					</div>
				</li>
				<li id="li-descripcion-tienda" class="item-pedido-usuario"><label
					class="description" for="descripcion_tienda">Descripcion </label>
					<div>
					<input type="text" class="element text medium" maxlength="255" name="descripcion_tienda" />
					</div>
				</li>
				<li id="li-ciudad" class="item-pedido-usuario"><label
				...
				<li id="li-zona" class="item-pedido-usuario"><label
