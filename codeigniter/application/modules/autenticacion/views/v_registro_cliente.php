...
<?php echo form_open('autenticacion/c_registro_usuario');?>
	...
	<ul>
		...
		<li id="li_1"><?php echo lang('regcliente_usuario','element_1','description');?>
			<div>
				<input id="element_1" name="usuario" style="float: left;" class="element text medium"
					type="text" maxlength="255"
					value="<?php echo set_value('usuario');?>" />
					<?php echo form_error('usuario','<p class="error">','</p>');?>
				<input id="btn_comprobar_usuario"
					class="button_text art-button" type="button" name="btn_comprobar_usuario"
		...
		<li id="li_16"><?php echo lang('regcliente_zona','element_16','description');?>
			<div>
				<select class="element select medium" id="element_16" name="zona">
